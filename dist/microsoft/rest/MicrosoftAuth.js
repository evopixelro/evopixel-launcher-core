...
MicrosoftAuth.logger = LoggerUtil_1.LoggerUtil.getLogger('MicrosoftAuth');
MicrosoftAuth.TIMEOUT = 2500;
MicrosoftAuth.TOKEN_ENDPOINT = 'https://login.microsoftonline.com/consumers/oauth2/v2.0/token';
MicrosoftAuth.XBL_AUTH_ENDPOINT = 'https://user.auth.xboxlive.com/user/authenticate';
MicrosoftAuth.XSTS_AUTH_ENDPOINT = 'https://xsts.auth.xboxlive.com/xsts/authorize';
MicrosoftAuth.MC_AUTH_ENDPOINT = 'https://api.minecraftservices.com/authentication/login_with_xbox';
MicrosoftAuth.MC_ENTITLEMENT_ENDPOINT = 'https://api.minecraftservices.com/entitlements/mcstore';
MicrosoftAuth.MC_PROFILE_ENDPOINT = 'https://api.minecraftservices.com/minecraft/profile';
MicrosoftAuth.STANDARD_HEADERS = {
